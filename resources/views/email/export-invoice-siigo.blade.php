...
<body>
    <div class="container">
        <div class="header {{ $success ? 'success' : 'error' }}">
            {{ $success ? '✔️ Exportación de facturas lista' : '❌ Falló la exportación de facturas' }}
        </div>

        <div class="content">
            @if ($success)
                <p>Tu exportación de facturas Siigo está lista para descargar.</p>
            ...
            @else
                <p>Ocurrió un error al generar la exportación de facturas Siigo.</p>
