...
<body>
    <div class="container">
        <div class="header {{ $success ? 'success' : 'error' }}">
            {{ $success ? '✔️ Exportación de inventario lista' : '❌ Falló la exportación de inventario' }}
        </div>

        <div class="content">
            @if ($success)
                <p>Tu exportación de inventario Siigo está lista para descargar.</p>
            ...
            @else
                <p>Ocurrió un error al generar la exportación de inventario Siigo.</p>
