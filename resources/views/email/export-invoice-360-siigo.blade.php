...
<body>
    <div class="container">
        <div class="header {{ $success ? 'success' : 'error' }}">
            {{ $success ? '✔️ Exportación de facturas 360 lista' : '❌ Falló la exportación de facturas 360' }}
        </div>

        <div class="content">
            @if ($success)
                <p>Tu exportación de facturas 360 Siigo está lista para descargar.</p>
            ...
            @else
                <p>Ocurrió un error al generar la exportación de facturas 360 Siigo.</p>
