...
<head>
    ...
    <title>Acceso a Ordenes de compra</title>
    <style>
...
<body>
    ...
    <div class="excel-upload-wrapper">
        <div class="excel-upload-card">
            ...
            <div class="excel-upload-title">Acceso a Ordenes de compra</div>
            ...
            <form action="{{ route('siigo.invoice_purchase_order_send_access_link') }}" method="POST" id="accessForm">
                @csrf
                ...
                <div class="excel-field-group">
                    ...
                    <div class="excel-field-hint">
                        Solo correos autorizados del equipo de compras/tecnología pueden solicitar acceso.
                    </div>
                </div>
