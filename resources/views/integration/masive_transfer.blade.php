<!-- ============================================= -->
<!-- Componente: Carga de archivo Excel            -->
<!-- Pega esto dentro de tu vista Blade             -->
<!-- ============================================= -->
...
<div class="excel-upload-wrapper">
    <div class="excel-upload-card">
        ...
        <form action="/siigo/masive_transfer_load" method="POST" enctype="multipart/form-data" id="excelUploadForm">
            @csrf
