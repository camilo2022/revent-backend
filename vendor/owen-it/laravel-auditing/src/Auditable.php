...
trait Auditable
{
    ...
    */
    ...
    {
        $old = collect($old)->values()->toArray();

        $new = collect($new)->values()->toArray();

        $this->auditCustomOld[$relationName] = $old;
        $this->auditCustomNew[$relationName] = $new;
