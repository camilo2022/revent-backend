...
class InvoiceSiigoController extends Controller
{
    ...
    {
        return view('integration.export_invoice');
    }

    public function export_invoice_download(Request $request)
    {
        ...
        ExportInvoiceSiigoJob::dispatch($filters, $emails);

        return view('integration.export_invoice_download', compact('emails'));
    }
}
