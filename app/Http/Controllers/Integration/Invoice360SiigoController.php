...
{
    public function export_invoice_360()
    {
        return view('integration.export_invoice_360');
    }

    public function export_invoice_360_download(Request $request)
    {
        ...
        return view('integration.export_invoice_360_download', compact('emails'));
    }
}
