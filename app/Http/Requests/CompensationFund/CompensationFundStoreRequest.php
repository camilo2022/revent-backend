...
class CompensationFundStoreRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'uppercase', 'string', 'min:4', 'max:50', 'unique:subitems,name,NULL,id,item_id,' . CompensationFund::ITEM_ID],
