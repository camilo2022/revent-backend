...
class HealthEntityStoreRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'uppercase', 'string', 'min:4', 'max:50', 'unique:subitems,name,NULL,id,item_id,' . HealthEntity::ITEM_ID],
