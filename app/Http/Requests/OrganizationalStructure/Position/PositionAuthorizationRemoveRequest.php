...
class PositionAuthorizationRemoveRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'permission_id' => ['required', 'numeric', 'exists:permissions,id', 'exists:model_has_permissions,permission_id,model_type,' . Position::class . ',model_id,' . $this->route('id')]
        ];
    }
