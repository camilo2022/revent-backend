...
class PersonType extends Model implements Auditable
{
    ...
    public function document_types(): MorphToMany
    {
        return $this->morphedByMany(DocumentType::class, 'model', 'model_has_subitems', 'subitem_id', 'model_id');
    }
